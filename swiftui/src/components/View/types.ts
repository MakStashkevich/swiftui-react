...
export type ViewProviderProps = PropsWithChildren & {
    ...
    attributeTheme?: Attribute | Attribute[] | undefined
    ...
    /** Default iOS version for theme */
    defaultVersion?: string
    /** Forced iOS version for the current page */
    forcedVersion?: string | undefined
}

export type ViewScriptProps = Omit<ViewProviderProps, 'children'> & {
    /** Default theme name */
    defaultTheme: string
    /** Default iOS version for theme */
    defaultVersion: string
    /** HTML attribute modified based on the active iOS version */
    attributeVersion: DataAttribute
};